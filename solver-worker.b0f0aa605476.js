...
let solver=null,tables=null,pending=null,running=false,initialized=false,loading=false,loadConfig=null;
...
async function loadTables(){
 ...
 loading=true;let loaded=0;postMessage({type:'loading',loaded,total:3});
 try{
